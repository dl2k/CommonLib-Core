...
namespace CommonLib.Redis
{
    ...
    public class RedisHelper
    {
        ...
        public static List<Dictionary<string, string>> GetClientsInfo()
        {
            using (RedisClient client = GetClient())
            {
                return client.GetClientsInfo();
            }
        }
        ...
        public static void SetValue(string key, string value, TimeSpan expireIn)
        {
            using (RedisClient client = GetClient())
            {
        ...
        public static void SetValueIfExists(string key, string value, TimeSpan expireIn)
        {
            using (RedisClient client = GetClient())
            {
                client.SetValueIfExists(key, value, expireIn);
            }
        }
        ...
        public static bool SetValueIfNotExists(string key, string value)
        {
            using (RedisClient client = GetClient())
            {
                return client.SetValueIfNotExists(key, value);
            }
        }
        public static void SetValueIfNotExists(string key, string value, TimeSpan expireIn)
        {
            using (RedisClient client = GetClient())
            {
                client.SetValueIfNotExists(key, value, expireIn);
            }
        }
