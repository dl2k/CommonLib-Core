...

{
    ...
    public class SQLHelper
    {
        ...
        /// <param name="pCommandText">存储过程名称或者是SQL语句</param>
        /// <returns>受SQL命令影响的数据行数</returns>
        public int ExecuteNonQuery(DbTransaction pTransaction, string pCommandText)
        {
            return ExecuteNonQuery(pTransaction, CommandType.Text, pCommandText, null);
        }
        /// <summary>
        /// 在指定的事务下执行一个SQL命令(不带SQL命令参数),该命令不返回结果集
        /// </summary>
        ...
        /// <param name="pCommandText">存储过程名称或者是SQL语句</param>
        /// <returns>向前的只读数据读取器</returns>
        public DbDataReader ExecuteReader(DbTransaction pTransaction, string pCommandText)
        {
            return ExecuteReader(pTransaction, CommandType.Text, pCommandText, null);
        }
        /// <summary>
        /// 在指定的事务下,执行一个SQL命令(不带SQL命令参数)并返回一个向前的只读数据读取器
        /// </summary>
        ...
        /// <param name="pCommandText">存储过程名称或者是SQL语句</param>
        /// <returns>1x1 的结果集中所包含的对象</returns>
        public object ExecuteScalar(DbTransaction pTransaction, string pCommandText)
        {
            return ExecuteScalar(pTransaction, CommandType.Text, pCommandText, null);
        }
        /// <summary>
        /// 在指定的事务下,执行一个SQL命令(不带SQL命令参数)，该命令返回一个 1x1 的结果集
        /// </summary>
        ...
        /// <param name="pCommandText">存储过程名称或者是SQL语句</param>
        /// <returns>数据集</returns>
        public DataSet ExecuteDataset(DbTransaction pTransaction, string pCommandText)
        {
            return ExecuteDataset(pTransaction, CommandType.Text, pCommandText, null);
        }
        /// <summary>
        /// 在指定的事务下,执行一个SQL命令(不带SQL命令参数)并返回一个数据集
        /// </summary>
    ...
    /// 映射排除属性
    /// </summary>
    public class IgnoreDBColumnAttribute : Attribute
    {
    }
    #endregion
}
