    ...
    public class ValidateHelper
    {
        ...
        public static IDCardNo CheckIDCard(string no)
        {
            ...
            if (!string.IsNullOrEmpty(no))
            {
                ...
                result.Age = (int)(CommonUtils.GetNow().Date.Subtract(result.Birthday.Date).TotalDays / 365);
        ...
        {
            return Regex.IsMatch(strIn, @"^[0-9]\d*|0$");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IsLogin(string strIn)
        {
            return Regex.IsMatch(strIn, @"^1[3|4|5|7|8][0-9]\d{4,8}$") || Regex.IsMatch(strIn, @"^[a-zA-Z]{2,6}-[0-9]{4}$");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IS_USERNAME(string strIn)
        {
            return Regex.IsMatch(strIn, @"^[a-zA-Z]{2,6}-[0-9]{4}$");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IS_IDNo(string strIn)
        {
            return Regex.IsMatch(strIn, @"^[a-zA-Z]-[0-9]{14}-[0-9]{3}$");
        }
        ...
        public static bool IsLoginPwd(string strIn)
        {
            ...
            return Regex.IsMatch(strIn, @"^(?![\d]+$)(?![a-zA-Z]+$)(?![!#$%^&*]+$)[\da-zA-Z!@#$%^&*]{6,20}$");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IsVCode(string strIn)
        {
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IsCharacter(string strIn)
        {
            return Regex.IsMatch(strIn, @"^[\u4E00-\u9FA5\d\w\-\s]*[\u4E00-\u9FA5\d\w\-]+$");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IsValidMoney(string strIn)
        {
            return Regex.IsMatch(strIn, @"^(([0-9]\d*)(\.\d{1,2})?)$|(0\.0?([1-9]\d?))$");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool IsValidKFPREFIX(string strIn)
        {
            return Regex.IsMatch(strIn, @"^[a-zA-Z]{2,6}$");
        }

        public static bool IsUrl(string strIn)
        {
            return Regex.IsMatch(strIn, @"^(https?|ftp|file)://[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]+");
        }
        ...
        /// <param name="strIn"></param>
        /// <returns></returns>
        public static bool ISBankCardNo2(string strIn)
        {
            return Regex.IsMatch(strIn, @"^\d{16}|\d{19}$");
        }

        public static bool ISBankCardNo(string bankNo)
        {
            if (!ISBankCardNo2(bankNo))
                return false;

            int lastNum = int.Parse(bankNo.Substring(bankNo.Length - 1,
                    1));// 取出最后一位（与luhm进行比较）
