    ...
    public class DetectionRuleHelper
    {
        ...
        public static bool DetectionRule(VerificationType type, object columnValue)
        {
            switch (type)
            {
                ...
                case VerificationType.IS_LOGIN:
                    return ValidateHelper.IsLogin(columnValue.ToString());
                case VerificationType.IS_USERNAME:
                    return ValidateHelper.IS_USERNAME(columnValue.ToString());
                ...
                case VerificationType.IS_VALID_NUMBER:
                    return ValidateHelper.IsValidNumber(columnValue.ToString());
                case VerificationType.IS_CHARACTER:
                    return ValidateHelper.IsCharacter(columnValue.ToString());
                case VerificationType.IS_ID_NO:
                    return ValidateHelper.IS_IDNo(columnValue.ToString());
                case VerificationType.IS_MONEY_AMOUNT:
                    return ValidateHelper.IsValidMoney(columnValue.ToString());
                case VerificationType.IS_KF_PREFIX:
                    return ValidateHelper.IsValidKFPREFIX(columnValue.ToString());
                case VerificationType.IS_BANK_CARDNO:
                    return ValidateHelper.ISBankCardNo(columnValue.ToString());
