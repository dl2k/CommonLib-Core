...
namespace CommonLib.Configuration
{
    ...
    public class ConfigManager
    {
        ...
        //    try
        //    {
        //        string value = Microsoft.Extensions.Configuration. AppSettings[key];
        ...
        /// <returns></returns>
        public static T GetObjectConfigFromString<T>(string xmlString) where T : class
        {
            T ot = default(T);
            try
            {
        ...
        private static object SetValue(Type t, XmlNode xnode)
        {
            ...
            switch (t.ToString())
            {
                ...
                case "System.Decimal":
                    if (!string.IsNullOrEmpty(getNodeAttrValue(xnode, "value")))
                        return decimal.Parse(getNodeAttrValue(xnode, "value"));
                    break;
                                ...
                                case NodeAttribute.NodeType.Simple:
                                    {
                                        ...
                                        switch (tt.ToString())
                                        {
                                            ...
                                            case "System.Decimal":
                                                pi.SetValue(ot, decimal.Parse(o), null);
                                                break;
